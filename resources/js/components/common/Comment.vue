    ...
    <div class="content__action">
      ...
      <div class="content__action-action flex">
        ...
        <div
            ...
            :class="{ 'content__action-button--disable': activity ? activity.meta === comment || !comment : !comment }"
            @click="addComment"
        >
          {{ activity ? $t("activity-log.buttons.save") : $t("activity-log.buttons.comment") }}
        </div>
      </div>
    </div>
  </div>
